...
export async function signIn(
  ...
  // Do not block the tap on sign-out. A hung /api/auth/sign-out on a phone
  // looks like a dead button. Best-effort clear still runs in the background.
  ...
  throw new Error("Sign-in did not start. Try again, or use a regular (not Private) Safari window.");
}
